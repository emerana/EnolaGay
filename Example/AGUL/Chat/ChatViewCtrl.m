...
@interface ChatViewCtrl ()<UUInputFunctionViewDelegate, UUMessageCellDelegate, UITableViewDataSource, UITableViewDelegate>
{
...
- (void)viewDidLayoutSubviews
{
	...
	if (_inputFuncView.textViewInput.isFirstResponder) {
		_chatTableView.frame = CGRectMake(0, 0, self.view.uu_width, self.view.uu_height-_keyboardHeight);
		_inputFuncView.frame = CGRectMake(0, _chatTableView.uu_bottom, self.view.uu_width, 40);
	} else {
		_chatTableView.frame = CGRectMake(0, 0, self.view.uu_width, self.view.uu_height);
		_inputFuncView.frame = CGRectMake(0, _chatTableView.uu_bottom, self.view.uu_width, 40);
	}
}
...
- (void)initBasicViews
{
	_chatTableView = [[UITableView alloc] initWithFrame:CGRectMake(0, 0, self.view.uu_width, self.view.uu_height) style:UITableViewStylePlain];
