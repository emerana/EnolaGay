...
//        UIButton *firstBtn = _indicatorView.subviews[0]; // 指标按钮
//        [firstBtn setSelected:YES];
//        _secondLevelSelectedBtn1 = firstBtn;
//        UIButton *firstBtn2 = _indicatorView.subviews[6];   // 关闭按钮
...
- (void)setCurrentSelectedBtn:(UIButton *)selectedBtn {


    if(_currentSelectedBtn != selectedBtn) {
        [_currentSelectedBtn setSelected:NO];
    }
    
    [selectedBtn setSelected:YES];
    _currentSelectedBtn = selectedBtn;
