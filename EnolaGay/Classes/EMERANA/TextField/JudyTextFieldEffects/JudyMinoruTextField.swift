...
/**
 A MinoruTextField is a subclass of theJudyTextFieldEffects object, is a control that displays an UITextField with a customizable visual effect around the edges of the control.
 */
@IBDesignable open class JudyMinoruTextField: JudyTextFieldEffects {
