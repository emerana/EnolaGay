...
/**
 A YokoTextField is a subclass of theJudyTextFieldEffects object, is a control that displays an UITextField with a customizable 3D visual effect on the background of the control.
 */
@IBDesignable open class JudyYokoTextField: JudyTextFieldEffects {
